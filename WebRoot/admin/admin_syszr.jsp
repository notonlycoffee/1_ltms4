...
<%  
	int department_id = ((Admin)session.getAttribute("admin")).getDepartmentID();
	String department_name = DepartmentDAO.getName(department_id);
	List<Admin> adminList = AdminDAO.listSyszr(department_id);	
	...
	List<Teacher> teacherList = TeacherDAO.list(department_id);
...
<body>
<div id="position">您现在所在页面：系统管理&nbsp;&gt;&gt;&nbsp;<a class="child" href="admin_la.jsp" target="content">实验室主任管理</a></div>
...
<input type="hidden" name="method" value="addsyszr" />
<input type="hidden" name="role" value="4" />
<input type="hidden" name="departmentID" value="<%=department_id %>" />
<table cellspacing=0 cellpadding=1>
    ...
    <tr>
   		...
   		<td><input type="submit" value="设置为实验室主任" class="form_btn2"/></td>
    </tr>
</table>
</form>
