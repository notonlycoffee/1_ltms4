...
<body>
<div id="position">您现在所在页面：实验室管理&nbsp;&gt;&gt;&nbsp;<a href="ExperimentServlet?method=list_music&teacherID=<%= teacher.getId()%>" target="content">实验管理</a>&nbsp;&gt;&gt;&nbsp;添加实验信息</div>
...
<form action="ExperimentServlet" method="post" onsubmit="return submitfrm(this);" id="ex_form_ltms">
<input type="hidden" name="method" value="add_music" />
<input type="hidden" name="departmentID" value="13" />
...
<input type="hidden" name="state" id="state" value="" />
	...
	<tr>
  		...
  		<td class="TD_Right"> 
    		<input type="text" name="symc"></input>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="TD_Right">
			<!-- 要设置成不可写   只能读 -->
			<textarea name="mxzy" rows="4" cols="35" id="mxzy_textarea" disabl></textarea><br/>
  	...
  	<tr>
  		...
  		<input type="button" value="返回" onclick="javascript:history.go(-1)" class="form_btn"/>
  		</td>
  	</tr>
</table>  
</form>
...
5.实验者专业里面的专业是对应于省系统的，如果没有学校对应的专业可以选择相似专业。<br/>
6.面向专业是对应于省系统数据，专业相似即可。选择过程必须是按照从上到下选择三个下拉列表，否则选择不成功
</div>
<script type="text/javascript">
$("#endWeek1").val("18");
$("#endTime1").val("2");
